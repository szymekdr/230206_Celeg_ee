...
ggplot(data = arrange(alldata_2, d_2), aes(x = d_2, y = 1:nrow(alldata_2),
  ...
  geom_errorbarh() +
  theme_classic() +
  scale_colour_manual(values = c("black", "red", "brown", "orange")) +
  labs(x = 'Cohen\'s d', y = 'Study ID') +
  facet_grid(cols = vars(isoline))
```